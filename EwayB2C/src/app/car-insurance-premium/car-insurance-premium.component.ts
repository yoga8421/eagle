...
//   otpArray: string[] = ['', '', '', '', '', '']; // Array for 6 OTP digits
// // otpValue: string = ''; // Final concatenated OTP value

// moveToNext(event: any, index: number): void {
//   // Auto-focus on the next box if a digit is entered
//   if (event.target.value && index < this.otpArray.length - 1) {
//     const nextInput = event.target.nextElementSibling;
//     if (nextInput) nextInput.focus();
//   }

//   // Concatenate OTP array to form a single value
//   this.otpValue = this.otpArray.join('');
//   console.log('Current OTP:', this.otpValue);
// }

// onOtpValidate(): void {
//   console.log('Final OTP:', this.otpValue);
...
//   // onOtpValidate() {
//   //   console.log('Validating OTP:', this.otpValue);
  
//   //   if (!this.otpValue) {
//   //     console.log("OTP is missing");
//   //     const errorMessage = '<div class="my-1"><i class="far fa-dot-circle text-danger p-1"></i>Please Enter OTP</div>';
      
//   //     // Display error to the user (Uncomment Swal or use an alternative)
//   //     // Swal.fire('Validation Error', errorMessage, 'error');
  
//   //     return errorMessage; // Exit early if OTP is missing
//   //   }
  
//     // Construct request object for OTP validation
//     const reqObj = {
//       CompanyId: this.insuranceId,
//       ProductId: this.productId,
//       AgencyCode: this.agencyCode,
...
//               (err: any) => `<div class="my-1"><i class="far fa-dot-circle text-danger p-1"></i>${err.Message}</div>`
//             ).join('');
            
//             // Swal.fire('Validation Errors', errorMessages, 'error'); // Uncomment to show errors
  
//             return; // Exit if validation errors exist
//           }
...
//           const loginId = this.MobileCodeDesc + this.MobileNo;
//           this.LoginId = loginId;
...
//           const userDetails = JSON.parse(sessionStorage.getItem('Userdetails') as string);
//           Object.assign(userDetails.Result, {
//             ProductId: this.productId,
//             ProductName: this.userDetails.Result.ProductName,
//             BrokerBranchCode: this.brokerbranchCode,
//             BranchCode: this.branchCode,
//             CurrencyId: this.userDetails.Result.CurrencyId,
...
//         },
//         (error: any) => {
//           console.error('API Error during OTP validation:', error);
  
//           // Swal.fire('Error', 'An error occurred while validating the OTP. Please try again.', 'error');
//         }
//       );
//     } catch (error) {
